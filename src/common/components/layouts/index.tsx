    ...
    <>
      ...
      >
        {isFullPageHeader ? (
          ...
          <div className='flex flex-col lg:flex-row lg:gap-4 lg:py-4 xl:gap-6 xl:pb-8'>
            <HeaderSidebar />
            <main className='w-full max-w-full transition-all duration-300 lg:w-4/5 lg:max-w-[915px] xl:max-w-[1000px]'>
              {children}
            </main>
          </div>
        )}
