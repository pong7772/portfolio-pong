...
const Resume = () => {
  const RESUME_URL = 'https://docs.google.com/document/d/1me37zoAtV_49u6fJc_ZYdSUy7ipR6o1NbOdGaDFzfAM/edit?usp=sharing';
  ...
  return (
    <div className='space-y-5'>
      ...
      <GoogleDocsEmbed src='https://docs.google.com/document/d/1me37zoAtV_49u6fJc_ZYdSUy7ipR6o1NbOdGaDFzfAM/edit?usp=sharing' />
    </div>
  );
};
